...
| Print / export | GDI+ → printer DC / EMF metafile |
| Updater | HTTPS manifest + downloader |
| Installer | Signed NSIS / Inno Setup package |
| Build | Visual Studio (MSVC), x86 / x64 |
